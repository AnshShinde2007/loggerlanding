...
export default function PhoneScreensSection() {
    return (
        <section id="phone-screens" className="py-20 px-6 sm:px-12 lg:px-16">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="mt-6 text-lg font-semibold">Add Exercise</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="mt-6 text-lg font-semibold">Today's Summary</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="mt-6 text-lg font-semibold">Progress Tracking</p>
                    </div>
                </div>
                ...
                <div className="mt-16 text-center">
                    ...
                    <a
                        ...
                        className="px-8 py-4 bg-black text-white rounded-lg font-semibold text-lg hover:bg-gray-800 transition-colors"
                    >
                        Join Waitlist
                    </a>
                </div>
