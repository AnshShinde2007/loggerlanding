export default function JoinCommunitySection() {
    return (
        <section id="community" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-16 bg-black text-white">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 mb-10 sm:mb-12 max-w-2xl mx-auto">
                    ...
                    <a
                        href="#"
                        className="p-5 sm:p-6 border-2 border-white rounded-2xl hover:bg-white hover:text-black transition-colors group"
                    >
                        <div className="flex items-center justify-center gap-3 mb-2 sm:mb-3">
                            ...
                            <span className="text-lg sm:text-xl font-bold">Discord</span>
                        </div>
                        <p className="text-gray-300 group-hover:text-black text-sm sm:text-base">Join our Discord server</p>
                    </a>
                    ...
                    >
                        ...
                        <p className="text-gray-300 group-hover:text-black text-sm sm:text-base">Follow us on Instagram</p>
                    </a>
                </div>
            </div>
        </section>
