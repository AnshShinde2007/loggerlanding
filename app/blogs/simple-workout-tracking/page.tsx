        ...
        <main className="w-full">
            ...
            <article className="max-w-4xl mx-auto px-6 sm:px-12 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <h2 className="text-3xl font-bold mt-12 mb-4">1. Less Friction, More Consistency</h2>
                    ...
                    <h2 className="text-3xl font-bold mt-12 mb-4">2. You Actually Use It</h2>
                    <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    <h2 className="text-3xl font-bold mt-12 mb-4">3. Focus on What Matters</h2>
                    <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    <h2 className="text-3xl font-bold mt-12 mb-4">4. Faster In, Faster Out</h2>
                    <p className="text-gray-700 leading-relaxed mb-6">
                    ...
                    <h2 className="text-3xl font-bold mt-12 mb-4">5. Your Data, Your Way</h2>
                    <p className="text-gray-700 leading-relaxed mb-6">
